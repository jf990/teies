...
:PURPOSE.
         ...
         items will be considered to apply to an ordered list.  This
         routine will also incriment the number of ordered lists that
...

{
   ...
   if (CHK_MASK (f_fmat->status, HEADING))
    ...
    list.type  = ORD_LIST;             /* code for ordered list        */
    list.level = f_fmat->ol_level;     /* gives current level of lists */
