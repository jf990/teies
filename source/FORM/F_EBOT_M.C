...
struct f_fmat_s *f_fmat;
{
   ...
   bot_mat->win_len  = bot_mat->w_max_y - bot_mat->w_min_y ;
   bot_mat->v_max_y  = bot_mat->win_len / p_prof->scrn_len ;
   ...
   if (f_fmat->cur_x != f_fmat->org_x + f_fmat->lef_mar)
   {
      ...
      f_fmat->cur_y = f_fmat->cur_y - (real) f_fmat->spacing ;
                                  ...
                                  /* Adjust window and max_y of body   */
   p_prof->body->win_len = p_prof->body->win_len - bot_mat->win_len ;
